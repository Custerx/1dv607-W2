...
{
    public class CompareAgeStrategy : Model.Database, ISearchCompareAgeStrategy
    {
        private int _thisYear = 2018; // Used to calculate age from personalnumber.

        public List<Model.Member> compareAgeSearch(Model.SearchMember searchCriteria, bool younger)
        {
